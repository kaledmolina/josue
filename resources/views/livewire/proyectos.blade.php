<section class="min-h-screen flex flex-col items-center justify-center py-20 bg-black relative overflow-hidden">
    ...
    <div class="absolute -bottom-20 -right-20 w-96 h-96 bg-cyan-500/5 rounded-full blur-3xl animate-pulse"></div>

    <div class="w-full max-w-7xl mx-auto px-4 lg:px-8 relative z-10">
        <div data-aos="fade-down" class="text-center mb-12">
            <h2 id="proyectos" data-letters class="text-3xl md:text-4xl font-bold text-white font-dearest mb-2">
                Mis Proyectos
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 w-full">
            ...
            <a href="/fotografias" wire:navigate data-aos="fade-right" data-aos-delay="100"
                class="tilt shine group relative h-[400px] rounded-3xl overflow-hidden cursor-pointer shadow-2xl border border-white/10 transition-all duration-500 hover:-translate-y-2 hover:shadow-white/10">
